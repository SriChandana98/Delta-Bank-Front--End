...
postCustomer(){
  ...
  this.http.post("http://localhost:3200/balance",
    {
      
        //"accountnumber":RegisterComponent.accountnumber,
        "balance":this.amount
        
  })
  .toPromise()
  .then(()=>{this.response="Insertion successfull"})
  //RegisterComponent.accountnumber=RegisterComponent.accountnumber+1;
  console.log("afterpost");
 }
